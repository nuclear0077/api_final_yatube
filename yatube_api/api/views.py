...
from api.serializers import PostSerializer, FollowSerializer, GroupSerializer, CommentSerializer
...
class FollowViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        if following.following.filter(user=self.request.user):
            raise ValidationError(f'вы уже подписаны на'
                                  f'пользователя {following}')
